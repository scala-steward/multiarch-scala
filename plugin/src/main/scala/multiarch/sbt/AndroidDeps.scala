...
/** Resolves Android-specific runtime dependencies for APK builds.
  ...
  *
  * Use when compiling Android projects that depend on PanamaPort APIs (e.g. `java.lang.foreign`
  * backports). Desktop JVM uses JDK 22+ java.lang.foreign directly and does not need these.
  */
object AndroidDeps {
